defmodule RolezinhoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RolezinhoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RolezinhoWeb.Gettext, "errors", msg, opts)
    end
  end
